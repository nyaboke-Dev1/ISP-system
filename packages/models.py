...
class Package(models.Model):
    ...
    speed = models.IntegerField(
        default=10, help_text="Download speed in Mbps"
    )  # Keep your field name
    ...
    data_cap = models.IntegerField(
        null=True, blank=True, help_text="Data cap in GB. Leave blank for unlimited."
    )
    ...
    def __str__(self):
        return f"{self.name} - {self.speed}Mbps - KES {self.price}"
