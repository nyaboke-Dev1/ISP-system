...
class CustomerSignUpForm(UserCreationForm):
    ...
    address = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={"class": "form-control", "rows": 3, "placeholder": "123 Main Street"}
        ),
    )
    city = forms.CharField(
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Nairobi"}
        ),
    )
    ...
    class Meta:
        ...
        widgets = {
            "subject": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Brief description"}
            ),
